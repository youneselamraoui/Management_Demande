...
export default function AppShell({ active, onNavigate, user, breadcrumb, children }) {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      <aside className="hidden w-64 shrink-0 flex-col border-r border-sidebar-border bg-sidebar p-4 lg:sticky lg:top-0 lg:flex lg:h-screen lg:overflow-y-auto scrollbar-hide">
